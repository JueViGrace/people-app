package com.jvg.peopleapp.home.presentation.state
...
sealed class RequestState<out T> {
    ...
    fun getSuccessDataOrNull(): T? {
        return try {
            ...
            Log.e("getSuccessDataOrNull", "getSuccessDataOrNull: ${e.message}",)
            null
        }
    }
    ...
    fun getErrorMessageOrEmpty(): String {
        return try {
            ...
            Log.e("getErrorMessageOrEmpty", "getErrorMessageOrEmpty: ${e.message}",)
            ""
        }
    }
